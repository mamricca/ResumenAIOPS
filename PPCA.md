...
Probabilistic Principal Component Analysis (PPCA) es una versión probabilística de [[PCA]] que modela cómo se generan los datos a partir de un conjunto reducido de variables latentes.
- ## Idea
...
- ## Idea clave
  ...
  PPCA combina la reducción de dimensionalidad de [[PCA]] con un modelo generativo probabilístico, permitiendo representar, reconstruir y generar observaciones.
- ## Relacionado
- [[PCA]]
- [[Likelihood]]
